// Создание кода T4 для модели "D:\Документы\Математическое моделирование\Учебно-производственная практика\СМО АЗС\SMO AZS\SMO AZS\Models\SMOAZSModel.edmx" включено. 
